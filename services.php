			...
			<div class="services-grids">
				...
				<div class="col-md-6 services-grid">
					...
					<div class="col-md-6 services-grid">
						...
						<div class="caption">
							<h4>Braithwaite/Horsley Water Tank</h4>
							<p></p>
					...
					<div class="col-md-6 services-grid">
						<div class="ser-img">
							<img src="images/b33.jpg" alt=" ">
						</div>
						<div class="caption">
							<h4>Petroleum products storage-tanks and stands.</h4>
							<p></p>
					...
					<div class="col-md-6 services-grid">
						...
						<div class="caption">
							<h4>Warehouse steel structure</h4>
							<p></p>
					...
					<div class="col-md-6 services-grid">
						...
						<div class="caption">
							<h4>Multi-storey steel structure.</h4>
							<p></p>
					...
					<div class="col-md-6 services-grid">
						...
						<div class="caption">
							<h4>Steel trusses for roofing.</h4>
							<p></p>
	...
	<div class="banner_bottom">
		<div class="container">
			<div class="tittle_head">
				<h3 class="tittle">Other Services;</h3>
			</div>
				<div class="ser-first">
					<div class="inner_sec_info_wthree_agile">
						<div class="col-md-4 ser-first-grid text-center">
							<span class="fa fa-shield" aria-hidden="true"></span>
							<h3>STEEL ERECTION/INSTALLATION OPERATIONS.</h3>
							<p> </p>
						</div>
						<div class="col-md-4 ser-first-grid text-center">
							<span class="fa fa-pencil" aria-hidden="true"></span>
							<h3>INTEGRITY ACCESSMENT OF EXISTING STEEL STRUCTURES.</h3>
							<p></p>
						</div>
						<div class="col-md-4 ser-first-grid text-center">
							<span class="fa fa-star" aria-hidden="true"></span>
							<h3>MAINTENANCE OF EXISTING STATIC AND NON-STATIC STEEL STRUCTURES.</h3>
							<p></p>
						</div>
						<div class="col-md-4 ser-first-grid text-center">
							<span class="fa fa-star" aria-hidden="true"></span>
							<h3>CORROSSION EVALUATION, MONITORING, CONTROL, AND PREVENTION.</h3>
							<p> </p>
						</div>
						<div class="col-md-4 ser-first-grid text-center">
							<span class="fa fa-flash" aria-hidden="true"></span>
							<h3>WELDING AND FABRICATION TRAINGING.</h3>
							<p> </p>
						</div>
