	...
	<div class="banner_bottom">
		<div class="container">
			...
			while($row = mysqli_fetch_array($run)){
				...
				$reduce_size = substr ($pcon,0,30);
		
				
			echo"
					<div class='col-md-6 blog_img'>
						<div class='blog_con'>
							<a href='single.html'><img src='admin/post_image/$img' style='height:200px;' alt=' ' class='img-responsive'></a>
							<div class='blog_info'>
								<h4>$pdate</h4>
								<h5><a href='single.php?id=$pid'>$ptitle</a></h5>
								<p>$reduce_size...<b>READ MORE</b></p>
							</div>
						</div>
					</div>
