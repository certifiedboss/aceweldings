 ...
 <div class="container-fluid">
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
		...
		<li class="bg_lg span3"> <a href="viewproject.php"> <i class="icon-envelope"></i>View Project</a> </li>
                  ...
                  <tbody>
                    <tr>
					 <td>$pid</td>
					  ...
					  <td class='right'><a href='viewproject.php?del=$pid' style='background-color:darkblue; margin-left:35%; color:white; padding:5px; font-size:15px; border:1px solid black; border-radius:5px; letter-spacing:4px;' ><b>Delete</b></a></td>
                    </tr>
							...
							if (isset($_GET['del']))
{
	...
	$del_user="delete from projecttbl where projectid='$del'";
	...
	{
		  echo "<script>window.open('viewproject.php?view','self')</script>";	
	}
}
