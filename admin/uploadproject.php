...
<!--End-Chart-box--> 
  ...
  <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="uploadproject.php" method="POST" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="file" name="file" class="span11" />
              </div>
            </div>
...
$qry = "INSERT INTO `projecttbl`(`post_img`) VALUES ('$ifile')";
